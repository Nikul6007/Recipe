    ...
    <div className="uk-width-3-4@s">
      ...
      <form className="uk-text-center">
        <div className="uk-width-1-1 uk-margin">
          <label className="uk-form-label" for="name">Full name</label>
          <input id="name" className="uk-input uk-form-large uk-border-pill uk-text-center" type="text" placeholder="Tom Atkins"></input>
        </div>
        <div className="uk-width-1-1 uk-margin">
          <label className="uk-form-label" for="email">Email</label>
          <input id="email" className="uk-input uk-form-large uk-border-pill uk-text-center" type="email" placeholder="tom@company.com"></input>
        </div>
        <div className="uk-width-1-1 uk-margin">
          <label className="uk-form-label" for="password">Password</label>
          <input id="password" className="uk-input uk-form-large uk-border-pill uk-text-center" type="password" placeholder="Min 8 characters"></input>
        </div>
